...
export const MOCK_EXPLORE_LISTINGS: (Listing & MockListingExtra)[] = [
  { id: "l1", vendorId: "v1", title: "Jollof & Plantain Bowl", priceMinor: 6500, priceMinMinor: 6500, priceMaxMinor: null, categoryId: "food", description: "Classic campus jollof with fried plantain.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq1/400/300"], rating: 4.8, verified: true, featured: true, availability: "open", categorySlug: "food", trending: true },
  { id: "l2", vendorId: "v2", title: "Campus Textbook Bundle", priceMinor: 12000, priceMinMinor: 12000, priceMaxMinor: null, categoryId: "books", description: "Core semester textbooks bundled.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq2/400/300"], rating: 4.5, verified: true, availability: "open", categorySlug: "books" },
  { id: "l3", vendorId: "v3", title: "Braided Hair Styling", priceMinor: 9000, priceMinMinor: 9000, priceMaxMinor: null, categoryId: "beauty", description: "Box braids and twists.", isPublished: true, status: "active", isFeatured: false, images: [], rating: 4.9, verified: false, availability: "open", categorySlug: "beauty", trending: true },
  { id: "l4", vendorId: "v1", title: "Suya Skewers (10)", priceMinor: 4000, priceMinMinor: 4000, priceMaxMinor: null, categoryId: "food", description: "Char-grilled beef suya.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq4/400/300"], rating: 4.6, verified: true, soldOut: true, availability: "closed", categorySlug: "food" },
  { id: "l5", vendorId: "v4", title: "Printed Hoodie (NMU)", priceMinor: 15000, priceMinMinor: 15000, priceMaxMinor: null, categoryId: "apparel", description: "Custom NMU hoodie.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq5/400/300"], rating: 4.3, verified: true, featured: true, availability: "soon", categorySlug: "apparel" },
  { id: "l6", vendorId: "v5", title: "Tutoring — Calculus", priceMinor: 8000, priceMinMinor: 8000, priceMaxMinor: null, categoryId: "services", description: "One-on-one calculus help.", isPublished: true, status: "active", isFeatured: false, images: [], rating: 5.0, verified: true, availability: "open", categorySlug: "services" },
  { id: "l7", vendorId: "v2", title: "Used Calculus Textbook", priceMinor: 5500, priceMinMinor: 5500, priceMaxMinor: null, categoryId: "books", description: "Pre-owned calculus text.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq7/400/300"], rating: 4.1, verified: false, availability: "open", categorySlug: "books" },
  { id: "l8", vendorId: "v3", title: "Nail Art Set", priceMinor: 7000, priceMinMinor: 7000, priceMaxMinor: null, categoryId: "beauty", description: "Manicure and nail art.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq8/400/300"], rating: 4.7, verified: true, availability: "open", categorySlug: "beauty" },
  { id: "l9", vendorId: "v6", title: "Phone Repair (screen)", priceMinor: 11000, priceMinMinor: 11000, priceMaxMinor: null, categoryId: "services", description: "Screen replacement.", isPublished: true, status: "active", isFeatured: false, images: [], rating: 4.4, verified: true, featured: true, availability: "open", categorySlug: "services", trending: true },
  { id: "l10", vendorId: "v4", title: "Custom Tote Bag", priceMinor: 5000, priceMinMinor: 5000, priceMaxMinor: null, categoryId: "apparel", description: "Canvas tote, custom print.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq10/400/300"], rating: 4.2, verified: false, availability: "open", categorySlug: "apparel" },
  { id: "l11", vendorId: "v5", title: "Group Study Notes — Physics", priceMinor: 3000, priceMinMinor: 3000, priceMaxMinor: null, categoryId: "services", description: "Condensed physics notes.", isPublished: true, status: "active", isFeatured: false, images: [], rating: 4.0, verified: true, availability: "open", categorySlug: "books" },
  { id: "l12", vendorId: "v6", title: "Campus Snack Pack", priceMinor: 4500, priceMinMinor: 4500, priceMaxMinor: null, categoryId: "services", description: "Assorted snacks.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq12/400/300"], rating: 4.6, verified: true, availability: "open", categorySlug: "food" },

  // --- C.6 / B.16 stress fixture: 13 additional listings for v1 (Mama Nkechi) ---
  { id: "l13", vendorId: "v1", title: "Akara Plate", priceMinor: 1200, priceMinMinor: 1200, priceMaxMinor: null, categoryId: "food", description: "Bean cakes.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq13/400/400"], rating: 4.5, verified: true, availability: "open", categorySlug: "food" },
  { id: "l14", vendorId: "v1", title: "Meat Pie", priceMinor: 800, priceMinMinor: 800, priceMaxMinor: null, categoryId: "food", description: "Baked meat pie.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq14/400/560"], rating: 4.3, verified: true, availability: "open", categorySlug: "food" },
  { id: "l15", vendorId: "v1", title: "Chin Chin", priceMinor: 500, priceMinMinor: 500, priceMaxMinor: null, categoryId: "food", description: "Crunchy fried snack.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq15/560/400"], rating: 4.1, verified: false, availability: "open", categorySlug: "food" },
  { id: "l16", vendorId: "v1", title: "Spicy Jollof Rice Bowl", priceMinor: 3800, priceMinMinor: 3800, priceMaxMinor: null, categoryId: "food", description: "Jollof with extra pepper.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq16/560/400"], rating: 4.7, verified: true, featured: true, availability: "open", categorySlug: "food" },
  { id: "l17", vendorId: "v1", title: "Fried Yam with Egg", priceMinor: 2500, priceMinMinor: 2500, priceMaxMinor: null, categoryId: "food", description: "Yam and fried egg.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq17/400/400"], rating: 4.4, verified: true, availability: "open", categorySlug: "food" },
  { id: "l18", vendorId: "v1", title: "Pepper Soup Combo", priceMinor: 4900, priceMinMinor: 4900, priceMaxMinor: null, categoryId: "food", description: "Spicy pepper soup.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq18/400/560"], rating: 4.6, verified: true, availability: "soon", categorySlug: "food" },
  { id: "l19", vendorId: "v1", title: "Plantain and Beans", priceMinor: 2200, priceMinMinor: 2200, priceMaxMinor: null, categoryId: "food", description: "Beans and fried plantain.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq19/560/400"], rating: 4.2, verified: false, availability: "open", categorySlug: "food" },
  { id: "l20", vendorId: "v1", title: "Grilled Fish Platter", priceMinor: 6500, priceMinMinor: 6500, priceMaxMinor: null, categoryId: "food", description: "Grilled fish plate.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq20/560/400"], rating: 4.8, verified: true, featured: true, availability: "open", categorySlug: "food" },
  { id: "l21", vendorId: "v1", title: "Homemade Moi Moi with Custard", priceMinor: 3100, priceMinMinor: 3100, priceMaxMinor: null, categoryId: "food", description: "Steamed bean pudding.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq21/400/400"], rating: 4.5, verified: true, availability: "soon", categorySlug: "food" },
  { id: "l22", vendorId: "v1", title: "Party Jollof Catering for Events", priceMinor: 22500, priceMinMinor: 22500, priceMaxMinor: null, categoryId: "services", description: "Bulk catering.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq22/400/560"], rating: 4.9, verified: true, featured: true, trending: true, availability: "soon", categorySlug: "services" },
  { id: "l23", vendorId: "v1", title: "Fresh Okra Soup with Assorted Meat", priceMinor: 5500, priceMinMinor: 5500, priceMaxMinor: null, categoryId: "food", description: "Okra soup.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq23/560/400"], rating: 4.6, verified: true, availability: "open", categorySlug: "food" },
  { id: "l24", vendorId: "v1", title: "Breakfast Semo and Egusi Combo", priceMinor: 4500, priceMinMinor: 4500, priceMaxMinor: null, categoryId: "food", description: "Semo and egusi.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq24/560/400"], rating: 4.3, verified: false, soldOut: true, availability: "closed", categorySlug: "food" },
  { id: "l25", vendorId: "v1", title: "Small Chops Platter for Celebrations", priceMinor: 8500, priceMinMinor: 8500, priceMaxMinor: null, categoryId: "food", description: "Party small chops.", isPublished: true, status: "active", isFeatured: false, images: ["https://picsum.photos/seed/voeq25/560/400"], rating: 4.7, verified: true, soldOut: true, availability: "closed", categorySlug: "food" },
];
